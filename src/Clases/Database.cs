...
namespace FrbaCrucero.Clases
{
    public class Database
    {
        ...
        public static List<string> consultaObtenerListaFila(SqlCommand query)
        {
            DataTable table = getQueryTable(query);
            List<string> row = new List<string>();
        ...
        //--Actualizo el orden de los recorrido_tramo luego de quitar o agregar tramos a un recorrido
        public static void actualizarOrdenDeTramosDelRecorrido(int idRecorrido)
        {
            open();
            SqlCommand actualizarOrden = Database.createQuery("CONCORDIA.ActualizarOrden");
            actualizarOrden.CommandType = CommandType.StoredProcedure;
            actualizarOrden.Parameters.AddWithValue("@idRecorrido", idRecorrido);

            executeReadQuery(actualizarOrden);
            close();
        }

        public static DataTable ViajesDisponibles(String fechaBusqueda, int puertoSalida, int puertoLlegada)
        {
            open();
            SqlCommand procedureViajes = createQuery("CONCORDIA.ViajesDisponibles");//Creo a query del Store Procedure 
            procedureViajes.CommandType = CommandType.StoredProcedure;
            procedureViajes.Parameters.AddWithValue("@FECHA_BUSQUEDA", fechaBusqueda);
            procedureViajes.Parameters.AddWithValue("@PUERTO_INICIO", puertoSalida);
            procedureViajes.Parameters.AddWithValue("@PUERTO_FIN", puertoLlegada);

            DataTable resultado = executeReadQuery(procedureViajes).Tables[0];

            close();

            return resultado; // Saco el parametro que retorna
        }


        public static int valorViaje(int viaj_id) {
            
            open();
            SqlCommand procedurevalorViajes = createQuery("CONCORDIA.valorViaje");//Creo a query del Store Procedure 
            procedurevalorViajes.CommandType = CommandType.StoredProcedure;
            procedurevalorViajes.Parameters.AddWithValue("@viaj_id", viaj_id);

            SqlParameter retval = new SqlParameter("@RESULTADO", SqlDbType.Int);// Seteo el parametro que retorna el Store Procedure 
            retval.Direction = ParameterDirection.ReturnValue;

            procedurevalorViajes.Parameters.Add(retval);

            SqlDataReader resultado = procedurevalorViajes.ExecuteReader();

            close();

            return (int)procedurevalorViajes.Parameters["@RESULTADO"].Value; // Saco el parametro que retorna
        ...
        public static int modificarCrucero(int cruc_id, int fabr_id, string fecha_alta, int inhabilitado)
        {
            open();

            SqlCommand procidureCrucero = Database.createQuery("CONCORDIA.ModificarCrucero");
            procidureCrucero.CommandType = CommandType.StoredProcedure;
            procidureCrucero.Parameters.AddWithValue("@cruc_id", cruc_id);
            procidureCrucero.Parameters.AddWithValue("@fabr_id", fabr_id);
            procidureCrucero.Parameters.AddWithValue("@fecha_alta", fecha_alta);
            procidureCrucero.Parameters.AddWithValue("@cruc_inhabilitado", inhabilitado);
        ...
        public static List<String> busacDatosUsuario(int dni) 
        {
            SqlCommand procedureGetUsuario = createQuery("CONCORDIA.datosUsuario");
            procedureGetUsuario.CommandType = CommandType.StoredProcedure;//Setea la query para Stored Procedure 
            procedureGetUsuario.Parameters.AddWithValue("@usua_dni", dni);//Setea el parametro 

            return consultaObtenerListaFila(procedureGetUsuario);
        }

        public static int updateUsuario(int usua_id, int usua_dni, string usua_nombre, string usua_apellido, string usua_email, string usua_direccion, string usua_fecha_nac, int usua_telefono)
        {
            open();

            SqlCommand procedureUpdateUsuario = Database.createQuery("CONCORDIA.updateUsuario");
            procedureUpdateUsuario.CommandType = CommandType.StoredProcedure;
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_id", usua_id);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_dni", usua_dni);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_nombre", usua_nombre);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_apellido", usua_apellido);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_email", usua_email);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_direccion", usua_direccion);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_fecha_nac", usua_fecha_nac);
            procedureUpdateUsuario.Parameters.AddWithValue("@usua_telefono", usua_telefono);


            int resultado = procedureUpdateUsuario.ExecuteNonQuery();// Retorna el numero de filas afectadas o -1 si no se pudo
        ...
        public static int insertUsuario( int usua_dni, string usua_nombre, string usua_apellido, string usua_email, string usua_direccion, string usua_fecha_nac, int usua_telefono )
        {
            
            open();

            SqlCommand procedureInsertarUsuario = Database.createQuery("CONCORDIA.insertarUsuario");
            procedureInsertarUsuario.CommandType = CommandType.StoredProcedure;
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_dni", usua_dni);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_nombre", usua_nombre);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_apellido", usua_apellido);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_email", usua_email);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_direccion", usua_direccion);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_fecha_nac", usua_fecha_nac);
            procedureInsertarUsuario.Parameters.AddWithValue("@usua_telefono", usua_telefono);

            SqlParameter retval = new SqlParameter("@ID_REMPLAZO", SqlDbType.Int);// Seteo el parametro que retorna el Store Procedure 
            retval.Direction = ParameterDirection.ReturnValue;

            procedureInsertarUsuario.Parameters.Add(retval);

            SqlDataReader resultado = procedureInsertarUsuario.ExecuteReader();

            close();

            return (int)procedureInsertarUsuario.Parameters["@ID_REMPLAZO"].Value; // Saco el parametro que retorna
            

        }

        public static int cargarCompra(int viaj_id, int usua_id, int medi_pag, double precio) 
        {
            open();

            SqlCommand procedureCrearPasaje = Database.createQuery("CONCORDIA.crearPasaje");
            procedureCrearPasaje.CommandType = CommandType.StoredProcedure;
            procedureCrearPasaje.Parameters.AddWithValue("@viaj_id", viaj_id);
            procedureCrearPasaje.Parameters.AddWithValue("@usua_id", usua_id);
            procedureCrearPasaje.Parameters.AddWithValue("@medi_pago_id", medi_pag);
            procedureCrearPasaje.Parameters.AddWithValue("@precio", precio);

            SqlParameter retval = new SqlParameter("@ID_PASAJE", SqlDbType.Int);// Seteo el parametro que retorna el Store Procedure 
            retval.Direction = ParameterDirection.ReturnValue;

            procedureCrearPasaje.Parameters.Add(retval);

            SqlDataReader resultado = procedureCrearPasaje.ExecuteReader();

            close();

            return (int)procedureCrearPasaje.Parameters["@ID_PASAJE"].Value; // Saco el parametro que retorna
            

            
        }

        public static int cargarCabinaPasaje(int pasa_id, int cabi_id)
        {
            open();

            SqlCommand procidureCabina = Database.createQuery("CONCORDIA.cargarCabinaPasaje");
            procidureCabina.CommandType = CommandType.StoredProcedure;
            procidureCabina.Parameters.AddWithValue("@pasa_id", pasa_id);
            procidureCabina.Parameters.AddWithValue("@cabi_id", cabi_id);
        ...
        public static bool validarViajeAComprar(int usua_id, int viaj_id )
        {
            open();

            SqlCommand procedureValidacion = Database.createQuery("CONCORDIA.validarCompra");
            procedureValidacion.CommandType = CommandType.StoredProcedure;
            procedureValidacion.Parameters.AddWithValue("@viaj_id", viaj_id);
            procedureValidacion.Parameters.AddWithValue("@usua_id", usua_id);

            SqlParameter retval = new SqlParameter("@RESULTADO", SqlDbType.Int);// Seteo el parametro que retorna el Store Procedure 
            retval.Direction = ParameterDirection.ReturnValue;

            procedureValidacion.Parameters.Add(retval);

            SqlDataReader resultado = procedureValidacion.ExecuteReader();

            close();

            return !((int)procedureValidacion.Parameters["@RESULTADO"].Value > 0 ); // Saco el parametro que retorna
        
        }

        public static int cargarReserva(int usua_id, int viaj_id)
        {
            open();

            SqlCommand procedureCrearPasaje = Database.createQuery("CONCORDIA.crearReserva");
            procedureCrearPasaje.CommandType = CommandType.StoredProcedure;
            procedureCrearPasaje.Parameters.AddWithValue("@viaj_id", viaj_id);
            procedureCrearPasaje.Parameters.AddWithValue("@usua_id", usua_id);

            SqlParameter retval = new SqlParameter("@ID_RESERVA", SqlDbType.Int);// Seteo el parametro que retorna el Store Procedure 
            retval.Direction = ParameterDirection.ReturnValue;
            ...
            return (int)procedureCrearPasaje.Parameters["@ID_RESERVA"].Value; // Saco el parametro que retorna
            
        }

        public static int cargarCabinaReserva(int rese_id, int cabi_id)
        {
            open();

            SqlCommand procidureCabina = Database.createQuery("CONCORDIA.cargarCabinaReserva");
            procidureCabina.CommandType = CommandType.StoredProcedure;
            procidureCabina.Parameters.AddWithValue("@rese_id", rese_id);
            procidureCabina.Parameters.AddWithValue("@cabi_id", cabi_id);
        ...
        public static int persistirTramo(Tramo t)
        {
            ...
            if (idTramoVerificado == 0)
            {
                ...
                query.CommandType = CommandType.Text;
                {
                    ...
                    //Get the inserted query
                    int resultado = Convert.ToInt32(query.ExecuteScalar());
                    Database.close();
                    return resultado;
                }
            }
        ...
        public static void persistirRecorridoTramo(int idRecorrido, List<Tramo> tramos)
        {
            tramos.ForEach(t =>
            {
                string queryString = "INSERT [GD1C2019].[CONCORDIA].[recorrido_tramo] (reco_id, tram_id, orden) VALUES(@idRecorrido, @idTramo, @orden)";
                SqlCommand query = Database.createQuery(queryString);
                query.Parameters.AddWithValue("@idRecorrido", idRecorrido);
                query.Parameters.AddWithValue("@idTramo", t.Id);
                query.Parameters.AddWithValue("@orden", tramos.IndexOf(t) + 1 );
        ...
        public static void actualizarInhabilitacionDeRol(int id, int inhabilitado)
        {
            ...
            {
                open();
                SqlCommand actualizarOrden = Database.createQuery("CONCORDIA.InhabilitarUsuarios");
                actualizarOrden.CommandType = CommandType.StoredProcedure;
                actualizarOrden.Parameters.AddWithValue("@idRol", id);
        ...
        public static void verificarReservas()
        {
            ...
            string query1String = "INSERT [GD1C2019].[CONCORDIA].[cancelacion_reserva] (rese_id, canc_descripcion) " +
                                    "SELECT rese_id, 'Reserva expirada' FROM [GD1C2019].[CONCORDIA].[reserva] " +
                                    "WHERE rese_creacion < CONVERT(datetime, @fecha, 103) ";
            string query2String = "UPDATE CONCORDIA.reserva SET rese_inhabilitado = '1'" +
                                    "WHERE rese_creacion < CONVERT(datetime, @fecha, 103)";

            SqlCommand query1 = Database.createQuery(query1String);
            SqlCommand query2 = Database.createQuery(query2String);

            query1.Parameters.AddWithValue("@fecha", limitDate);
            query2.Parameters.AddWithValue("@fecha", limitDate);

            Database.executeCUDQuery(query1);
            Database.executeCUDQuery(query2);
        }
        ...
        public static DataTable detalleDeRecorridosConMasPasajesCompradosEn(int anioSeleccionado, int semestreSeleccionado, int idRecorrido)
        {
            ...
            string queryString = caseWhen + "FROM  GD1C2019.CONCORDIA.recorrido AS R, GD1C2019.CONCORDIA.viaje AS V, GD1C2019.CONCORDIA.pasaje AS P " +
                                            "WHERE R.reco_id = V.reco_id AND V.viaj_id = P.viaj_id AND R.reco_id = @idRecorrido AND " +
                                                "DATEPART(YEAR, P.pasa_fecha_compra) = @year AND " +
                                                "(DATEPART(QUARTER, P.pasa_fecha_compra) = @inicio OR DATEPART(QUARTER, P.pasa_fecha_compra) = @fin) " +
        ...
        public static DataTable detalleDeRecorridoConMasCabinasLibres(int anioSeleccionado, int semestreSeleccionado, int idRecorrido)
        {
            ...
            if (semestreSeleccionado == 1)
            {
                for (int i = 0; i <= 5; i++)
                {
                    ...
                    queryString += " SELECT " + mes + " AS Mes, (SELECT COUNT(*) AS cantDeCabinasLibres " +
    ...
    public class sqlDatos
    {
        ...
        public String NombreColumna { get { return nombreColumna; } set { nombreColumna = value; } }
        public String Dato { get { return dato; } set { dato = value; } }

        public sqlDatos(String _nombreColumna, String _dato) 
        {
            nombreColumna = _nombreColumna;
            dato = _dato;
        }
    }
}
