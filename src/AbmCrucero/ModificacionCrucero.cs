...
namespace FrbaCrucero.AbmCrucero
{
    public partial class ModificacionCrucero : Frame
    {
        ...
        {
            int resultado = Database.modificarCrucero(Convert.ToInt32(textBoxId.Text), comboBoxMarca.SelectedIndex + 1, textBoxFechaAlta.Text, (checkBoxInhabilitado.Checked ? 1 : 0));
