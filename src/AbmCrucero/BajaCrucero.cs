...
namespace FrbaCrucero.AbmCrucero
{
    public partial class BajaCrucero : Frame
    {
        ...
        private void bajaVidaUtil()
        {
            ...
            {   
                ...
                if (resultado_baja_crucero > 0)
                {
                    ...
                    //dividis por dos el resultado porque hace un update y despues un insert de los mismos datos
                    MessageBox.Show("Se dieron de baja " + (resultado/2).ToString() + " pasajes");
                }
                else
                {
            ...
            {   
                ...
                {
                    MessageBox.Show("No hay crucero que lo remplace, Cree un nuevo crucero yendo a la opcion alta en ABM CRUCEROS");
        ...
        {   
            ...
            {
                MessageBox.Show("Complete Hasta cuando va a estar dado de baja");
            }
        ...
        private void seleccionarFS_Click(object sender, EventArgs e)
        {
            ...
            int desplazamiento = ((TimeSpan)(dateTimePicker.Value - DateTime.Today)).Days;
            if (desplazamiento > 0)
            {
                diasDesplazamiento.Text = desplazamiento.ToString();
        ...
        {
            diasDesplazamiento.Visible = !cancPasFS.Checked;
            label3.Visible = !cancPasFS.Checked;

        }

        private void BajaCrucero_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
            this.Dispose();
            padre.Show();
        ...
        {
            this.BajaCrucero_FormClosed(sender, new FormClosedEventArgs(CloseReason.UserClosing));
        }
