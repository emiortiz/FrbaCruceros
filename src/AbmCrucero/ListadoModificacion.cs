...
{
    public partial class ListaModificacion : Frame
    {
        ...
        public ListaModificacion( AbmC _padre)
        {
            InitializeComponent();
            cargarMarcas();
            padre = _padre;
        ...
        private void ListadoModificacion_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
            this.Dispose();
            padre.Show();
        ...
        {
            this.ListadoModificacion_FormClosed(sender, new FormClosedEventArgs(CloseReason.UserClosing));
        }
