...
{
    public partial class ListadoBaja : Frame
    {
        ...
        public ListadoBaja(AbmC _padre)
        {
            InitializeComponent();
            cargarMarcas();
            padre = _padre;
        ...
        private void Buscar()
        {
            ...
            {
                MessageBox.Show("El campo id debe ser un numero entero o vacio");
            }
        }
        ...
        {   
            string condicion = "";
                ...
                condicion = " WHERE " + " cruc_inhabilitado = '0' ";
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                BajaCrucero modificacion = new BajaCrucero(cargarDatosCrucero(),this);
        ...
        private void ListadoBaja_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
            this.Dispose();
            padre.Show();
        ...
        {
            this.ListadoBaja_FormClosed(sender, new FormClosedEventArgs(CloseReason.UserClosing));
