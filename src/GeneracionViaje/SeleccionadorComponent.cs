...
{
    public partial class SeleccionadorComponent : Form
    {
        ...
        public SeleccionadorComponent(string _consulta, string _filtro1, string _filtro2, GenerarViaje _padre, bool _crucero)
        {
            InitializeComponent();
            consulta = _consulta;
        ...
        private string generadorDeCondicion(List<string> parametros)
        {
            ...
            if (parametros.Count != 0)
            {
                ...
                if (crucero)
                {
                    condicion += " AND " + " cruc_inhabilitado = '0'";
                }
        ...
        private void SeleccionadorComponent_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
            this.Dispose();
            padre.Show();
