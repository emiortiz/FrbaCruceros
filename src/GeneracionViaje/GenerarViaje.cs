...
{
    public partial class GenerarViaje : Frame
    {
        string[] crucero;
        string[] recorrido;
        MenuPrincipal padre;

        public GenerarViaje( MenuPrincipal _padre )
        {
            InitializeComponent();
            padre = _padre;
        }
        ...
        private void btnSeleccionarCrucero_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SeleccionadorComponent sc = new SeleccionadorComponent(consulta, "cruc_id", "cruc_identificador",this,true);
                sc.ShowDialog();
        ...
        private void btnSeleccionarRecorrido_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SeleccionadorComponent sc = new SeleccionadorComponent(consulta, "reco_id", "reco_codViejo",this,false);
                sc.ShowDialog();
                recorrido = sc.seleccionado;
                textBoxRecorrido.Text = recorrido[0];
                sc.Dispose();
            }
            catch (Exception)
            {
        ...
        {
            this.GenerarViaje_FormClosed(sender, new FormClosedEventArgs(CloseReason.UserClosing));
        }
