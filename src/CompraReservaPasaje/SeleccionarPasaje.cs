...
namespace FrbaCrucero.CompraReservaPasaje
{
    public partial class SeleccionadorPasaje : Frame
    {
        ...
        {
            return textBoxFS.Text != "" && Convert.ToInt32(comboBoxPO.SelectedIndex) >= 0 && Convert.ToInt32(comboBoxPD.SelectedIndex) >= 0;
        }
        private void Buscar()
        {
            if (validarBusqueda())
            ...
            {
                MessageBox.Show("Complete todos los campos para buscar");
            }
        }
