...
namespace FrbaCrucero.Inicio
{
    public partial class MenuPrincipal : Frame
    {
        ...
        private void inicializarDiccFuncionalidades() //Para agregar las funcioens a los formularios correspondientes y sus respectivos ids
        {
            ...
            this.funcDisponibles.Add(5, () => new AbmCrucero.AbmC(this));
            this.funcDisponibles.Add(6, () => new CompraReservaPasaje.SeleccionadorPasaje(this));
            this.funcDisponibles.Add(7, () => new PagoReserva.PagoReserva(this));
            this.funcDisponibles.Add(8, () => new ListadoEstadistico.ListadoEstadistico(this));
            this.funcDisponibles.Add(9, () => new GeneracionViaje.GenerarViaje(this));
        }
